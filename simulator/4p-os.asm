...
OS_start:
    ...
    ;; save sp 
    la      R2, process_control_block
    addi    R2, R2, 2       ; sp is saved to process_control_block[1] for context switch 
    sw      R2, sp, 0
    ...
    ;; save sp 
    la      R2, process_control_block
    addi    R2, R2, 3       ; sp is saved to process_control_block[1] for context switch 
    sw      R2, sp, 0
...
save_context:
    ...
    movei   R2, 2
    addi    R3, R3, -1    
    blez    R3, switch_proc     ; if R3 == 1 then R2 <-2
    movei   R2, 3
    addi    R3, R3, -1
    blez    R3, switch_proc     ;if R3 == 2 then R2 <- 3
    movei   R2, 0
